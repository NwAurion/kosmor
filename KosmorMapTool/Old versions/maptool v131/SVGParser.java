...
public class SVGParser {
	...
	public static NodeList[] parseSVG(Date date) {
		...
		try {
			...
			System.out.println("Parsing the svg");		
			System.out.println("This should not longer than 30 seconds");	// Status message, again
			...
			System.out.println("Done parsing"); // Status message
