...
public class HTMLBuilder {
	...
	private static String createPlanetURL(LinkedList<Planet> planetList, int currentPos) {
		...
		planetAsURL = "http:kosmor.com/index.php?action=3000&xpos="+planet.xPos + "&ypos=" + planet.yPos;
	...
	private static String createWarPlanetURL(LinkedList<Planet> warplanetList, int currentPos) {
		...
		warplanetAsURL = "http:kosmor.com/index.php?action=3000&xpos="+planet.xPos + "&ypos=" + planet.yPos;
