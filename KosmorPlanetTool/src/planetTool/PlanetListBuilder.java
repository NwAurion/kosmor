...
public class PlanetListBuilder {
	...
	private static LinkedList<Planet> planetList = new LinkedList<Planet>();
	private static LinkedList<Planet> neutralPlanetList = new LinkedList<Planet>();
	private static LinkedList<Planet> warplanetList = new LinkedList<Planet>();

	private static LinkedList<LinkedList<Planet>> allPlanetsList = new LinkedList<LinkedList<Planet>>();
	 ...
	 */
	public static LinkedList<LinkedList<Planet>> buildPlanetList(
			String kosmorDate,
			Calendar date) {
		...
		PlanetListBuilder.generateAllPlanets();

		PlanetListBuilder.allPlanetsList.add(PlanetListBuilder.planetList);
		PlanetListBuilder.allPlanetsList
		.add(PlanetListBuilder.neutralPlanetList);
		PlanetListBuilder.allPlanetsList.add(PlanetListBuilder.warplanetList);
		return PlanetListBuilder.allPlanetsList;
	 ...
	 * the real work
	 */
	private static void generateAllPlanets() {
